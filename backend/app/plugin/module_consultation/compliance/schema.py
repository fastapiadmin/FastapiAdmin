...
class ComplianceDiagnosisCreateSchema(BaseSchema):
    ...
    diagnosis_details: Optional[dict] = Field(default=None, description="诊断详情")
    ...
    risk_warning: Optional[str] = Field(default=None, description="风险警告")
...
class ComplianceDiagnosisQuerySchema(BaseSchema):
    ...
    is_high_risk: Optional[bool] = Field(default=None, description="是否高风险")
