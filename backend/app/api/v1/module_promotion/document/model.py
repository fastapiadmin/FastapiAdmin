...
class PromotionDocumentModel(ModelMixin, UserMixin):
    ...
    document_summary: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="文档摘要"
    )
    ...
    is_top: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
        comment="是否置顶"
    )

    is_featured: Mapped[int | None] = mapped_column(
        Integer,
        nullable=True,
        comment="是否精选"
    )
    ...
    attachment_names: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
        comment="附件名称"
    )
