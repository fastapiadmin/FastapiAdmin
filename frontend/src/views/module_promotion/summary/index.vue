  ...
  <div class="app-container">
    <el-card class="search-card" shadow="never">
      <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="80px">
        ...
        <el-form-item label="总结类型" prop="summary_type">
          <el-select
            v-model="searchForm.summary_type"
            placeholder="请选择类型"
            clearable
            style="width: 140px"
          >
    ...
    <el-card class="table-card" shadow="never">
      <template #header>
        <div class="card-header">
          ...
          <div class="operations">
            <el-button
              v-permission="['module_promotion:summary:create']"
              type="primary"
              @click="handleCreate"
            >
              <i-ep-plus />
            ...
            <el-button
              v-permission="['module_promotion:summary:delete']"
              type="danger"
      ...
      >
        ...
        <el-table-column prop="summary_status" label="提交状态" width="100">
          <template #default="{ row }">
            <el-tag :type="getStatusType(row.summary_status)">
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button
              v-permission="['module_promotion:summary:detail']"
              link
              type="primary"
            ...
            <el-button
              v-permission="['module_promotion:summary:update']"
              link
              type="primary"
    ...
    <el-dialog v-model="detailDialog.visible" title="总结详情" width="650px">
      <el-descriptions v-if="detailDialog.data" :column="2" border>
        <el-descriptions-item label="总结单号">
          {{ detailDialog.data.summary_no }}
        ...
        <el-descriptions-item label="总结日期">
          {{ detailDialog.data.summary_date || "-" }}
        </el-descriptions-item>
        <el-descriptions-item label="提交人">
          {{ detailDialog.data.submitter_name || "-" }}
        </el-descriptions-item>
        <el-descriptions-item label="提交状态">
          <el-tag :type="getStatusType(detailDialog.data.summary_status)">
            {{ getStatusLabel(detailDialog.data.summary_status) }}
          </el-tag>
        </el-descriptions-item>
    ...
    <el-dialog
      ...
      :title="formDialog.type === 'create' ? '新增总结' : '编辑总结'"
      width="600px"
    >
