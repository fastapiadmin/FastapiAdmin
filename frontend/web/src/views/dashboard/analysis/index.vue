<template>
  <div>
    ...
    <!-- 卡片组件演示区 ← workplace -->
    <div class="console-cards-showcase border-g-200 mt-4">
      <div class="py-5">
        ...
        <h2 class="page-title">基础 & 自定义按钮+背景色</h2>
        <ElRow :gutter="20">
