...
export const MANUAL_SYSTEM_TAIL_PAGES: CompactManualPage[] = [
  ...
  },
  {
    ...
    notes: [
      "检索：ArtSearchBar（含创建人 UserTableSelect 槽）。",
      "主区：分页表格。",
      "工具栏：新增、导出、批量删除、批量更多(patch)、刷新、列配置。",
      "弹层：详情；新增/编辑 Dialog；导出 ArtExportDialog。",
  ...
  },
  {
    ...
    notes: [
      "检索：ArtSearchBar（含创建人 UserTableSelect）。",
      "工具栏：新增、导出、批量删除、批量更多(patch)、刷新、列配置。",
  ...
  },
  {
    ...
    notes: [
      "检索：ArtSearchBar（含创建人 UserTableSelect）；登录/操作日志类型在列或详情中区分。",
    ...
    pages: [
      ...
      },
      {
        ...
        notes: [
          "检索：ArtSearchBar + 分页表。",
          "工具栏：新增、批量删除、刷新、列配置。",
          "弹层：ArtDialog + 分栏（表单 + 扩展配置区）；编辑节点连接与执行参数。",
    ...
    pages: [
      {
        ...
        notes: [
          "检索：ArtSearchBar（含创建人、更新人 UserTableSelect）。",
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        path: "../locales/langs/**",
        notes: [
          "`src/locales/langs/*.json` 与 i18n 实例；顶栏/设置内切换语言并持久化到本地存储。",
        ],
      },
    ],
  },
